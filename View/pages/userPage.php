...
<header>
    ...
    <div class="middle" style="background-color:white; margin-top: 2%; margin-left: 15%; margin-right: 15%;border-radius: 20px ;">
        <?php
            if(isset($_SESSION['id']) && isset($_SESSION['username']) && isset($_SESSION['firstname']) && isset($_SESSION['user_type'])){
                $text = '<br><p style="text-align: center;">Bun venit pe pagina contului, ' . $_SESSION['firstname'] . '<br><br>' .
                    '<b>Username</b> : ' . $_SESSION['username'] . '<br>' .
                    '<b>Status</b> : ' . $_SESSION['user_type'] . '</p><br>';
                echo $text;
                echo "\n";
            }
        ?>
